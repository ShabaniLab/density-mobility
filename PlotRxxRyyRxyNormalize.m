function PlotRxxRyyRxyNormalize(B,Rxx,Ryy,Rxy,sampleName,linearRxyRangeBounds,textDataLocation)
    ...
    plot(xBounds,[1 1],'Color',[.8 0 0],'LineStyle','--','DisplayName','R_{yy} zero line');
    xlabel('B [T]');
